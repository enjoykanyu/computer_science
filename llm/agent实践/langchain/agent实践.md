...
实践（代码文件：[helloworld.py](file:///Users/kanyu/Desktop/project/kanyu_server/new_project/computer_science/llm/agent实践/langchain/实践/1，hello%20world/helloworld.py)）
...
```
地址（代码文件：[tool.py](file:///Users/kanyu/Desktop/project/kanyu_server/new_project/computer_science/llm/agent实践/langchain/实践/1，hello%20world/tool.py)）
