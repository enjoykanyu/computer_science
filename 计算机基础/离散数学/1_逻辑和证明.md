...
前提 p："今天是星期八"→ 假（根本没有星期八）
结论 q："我会飞"→ 不用管它真假
因为 p 是假的，p → q 自动为真。这个命题是真的！

听起来反直觉？但逻辑上确实如此——条件语句只在"前提真但结论假"时才为假，前提都假了，就没法反驳了
...
要证 p → q，我直接证 q 本身就是真的。既然 q 是真的，管你 p 是什么，p → q 一定为真。证明完毕。

命题："如果明天下雨，那么 1+1=2。"

前提 p："明天下雨"→ 不知道，不用管
结论 q："1+1=2"→ 真（恒真）
因为 q 恒真，p → q 自动为真。这个命题是真的！ 不管明天下不下雨。
---
...
# 8，证明方法与策略
### <font style="color:rgb(26, 26, 26);">8.1 穷举证明法（Exhaustive Proof）</font>
**<font style="color:rgb(26, 26, 26);">思路</font>**<font style="color:rgb(26, 26, 26);">：论域元素有限时，逐一验证每个元素。</font>

**<font style="color:rgb(26, 26, 26);">例</font>**<font style="color:rgb(26, 26, 26);">：证明 (n+1)³ ≥ 3ⁿ 对所有满足 1≤n≤4 的正整数 n 成立。</font>

<font style="color:rgb(91, 96, 102);">逐一验证 n=1,2,3,4 四种情况。</font>

**<font style="color:rgb(26, 26, 26);">局限</font>**<font style="color:rgb(26, 26, 26);">：只有论域很小时才可行。</font>

---

### <font style="color:rgb(26, 26, 26);">8.2 分情形证明法（Proof by Cases）</font>
**<font style="color:rgb(26, 26, 26);">思路</font>**<font style="color:rgb(26, 26, 26);">：将前提分解为若干互斥且穷尽的情形，逐一证明每种情形下结论成立。</font>
...
**<font style="color:rgb(26, 26, 26);">例</font>**<font style="color:rgb(26, 26, 26);">：证明 |xy| = |x|·|y|（x,y 为实数）。</font>

<font style="color:rgb(91, 96, 102);">分四种情形：x≥0,y≥0；x≥0,y<0；x<0,y≥0；x<0,y<0。</font>

**<font style="color:rgb(26, 26, 26);">不失一般性（WLOG）</font>**<font style="color:rgb(26, 26, 26);">：当多种情形本质上对称时，可以只证一种，声明"其他情形类似"。</font>

**<font style="color:rgb(26, 26, 26);">例</font>**<font style="color:rgb(26, 26, 26);">：如果 xy 和 x+y 都是偶数，则 x 和 y 都是偶数。</font>

<font style="color:rgb(91, 96, 102);">用反证法 + 不失一般性（假设 x 是奇数）+ 分情形（y 偶数 / y 奇数）。</font>

**<font style="color:rgb(26, 26, 26);">常见错误</font>**<font style="color:rgb(26, 26, 26);">：</font>

1. **<font style="color:rgb(26, 26, 26);">遗漏情形</font>**<font style="color:rgb(26, 26, 26);">（如忘了 x=0）</font>
2. **<font style="color:rgb(26, 26, 26);">从个例推断一般结论</font>**<font style="color:rgb(26, 26, 26);">（没穷举完就下结论）</font>

---

### <font style="color:rgb(26, 26, 26);">8.3 存在性证明（Existence Proof）</font>
<font style="color:rgb(26, 26, 26);">针对形如</font><font style="color:rgb(26, 26, 26);"> </font>**<font style="color:rgb(26, 26, 26);">∃xP(x)</font>**<font style="color:rgb(26, 26, 26);"> </font><font style="color:rgb(26, 26, 26);">的定理。</font>

| **<font style="color:rgb(26, 26, 26);">类型</font>**      | **<font style="color:rgb(26, 26, 26);">方法</font>**                             | **<font style="color:rgb(26, 26, 26);">特点</font>**      |
| :-------------------------------------------------------- | :------------------------------------------------------------------------------- | :-------------------------------------------------------- |
| **<font style="color:rgb(91, 96, 102);">构造性</font>**   | <font style="color:rgb(91, 96, 102);">直接找出一个具体元素 a 使 P(a) 为真</font> | <font style="color:rgb(91, 96, 102);">给出"物证"</font>   |
| **<font style="color:rgb(91, 96, 102);">非构造性</font>** | <font style="color:rgb(91, 96, 102);">不找出具体元素，用其他方式证明存在</font>  | <font style="color:rgb(91, 96, 102);">通常用归谬法</font> |


**<font style="color:rgb(26, 26, 26);">例10（构造性）</font>**<font style="color:rgb(26, 26, 26);">：1729 = 10³+9³ = 12³+1³，存在一个正整数可用两种方式表为立方和。</font>

**<font style="color:rgb(26, 26, 26);">例11（非构造性）</font>**<font style="color:rgb(26, 26, 26);">：存在无理数 x,y 使 xʸ 为有理数。</font>

<font style="color:rgb(91, 96, 102);">考虑 √2^√2。若为有理数，则 x=y=√2；若为无理数，则 x=√2^√2, y=√2 → xʸ = 2。无论哪种情况，都存在这样的 x,y，但我们不知道具体是哪一对。</font>

**<font style="color:rgb(26, 26, 26);">例12（蚕食游戏 Chomp）</font>**<font style="color:rgb(26, 26, 26);">：证明第一个玩家有必胜策略，但不给出具体策略。</font>

---

### <font style="color:rgb(26, 26, 26);">8.4 唯一性证明（Uniqueness Proof）</font>
**<font style="color:rgb(26, 26, 26);">思路</font>**<font style="color:rgb(26, 26, 26);">：证明 ∃!xP(x) 需要两步：</font>

1. **<font style="color:rgb(26, 26, 26);">存在性</font>**<font style="color:rgb(26, 26, 26);">：存在 x 满足 P(x)</font>
2. **<font style="color:rgb(26, 26, 26);">唯一性</font>**<font style="color:rgb(26, 26, 26);">：若 y 也满足 P(y)，则 y = x</font>

**<font style="color:rgb(26, 26, 26);">例13</font>**<font style="color:rgb(26, 26, 26);">：如果 a≠0，方程 ar+b=0 存在唯一解。</font>

<font style="color:rgb(91, 96, 102);">存在性：r = -b/a 是一个解。 唯一性：假设 s 也是解，则 ar+b = as+b → ar = as → r = s。</font>

---

### <font style="color:rgb(26, 26, 26);">8.5 证明策略（Proof Strategies）</font>
| **<font style="color:rgb(26, 26, 26);">策略</font>**          | **<font style="color:rgb(26, 26, 26);">说明</font>**                                                  |
| :------------------------------------------------------------ | :---------------------------------------------------------------------------------------------------- |
| **<font style="color:rgb(91, 96, 102);">正向推理</font>**     | <font style="color:rgb(91, 96, 102);">从前提出发，一步步推导到结论</font>                             |
| **<font style="color:rgb(91, 96, 102);">反向推理</font>**     | <font style="color:rgb(91, 96, 102);">从结论倒推，找"要证结论，只需证什么"</font>                     |
| **<font style="color:rgb(91, 96, 102);">改编现有证明</font>** | <font style="color:rgb(91, 96, 102);">参考类似定理的证明思路（如证 √3 无理数可模仿 √2 的证明）</font> |
| **<font style="color:rgb(91, 96, 102);">先试直接证明</font>** | <font style="color:rgb(91, 96, 102);">首选策略，如果走不通再换</font>                                 |
| **<font style="color:rgb(91, 96, 102);">再试反证法</font>**   | <font style="color:rgb(91, 96, 102);">前提难以直接利用时（如涉及无理数）</font>                       |
| **<font style="color:rgb(91, 96, 102);">最后试归谬法</font>** | <font style="color:rgb(91, 96, 102);">前两种行不通时</font>                                           |
